...
namespace _rootnamespace_
{
    ...
    public class UmbracoCustomOwinStartup : UmbracoDefaultOwinStartup
    {
        protected override void ConfigureServices(IAppBuilder app)
        {
            ...
            // *** Do not uncomment this code unless you are using a custom UserStore or custom Useramanger.
            /**
			...
			*/
             ...
             * For Azure Active Directory auth:		Install-Package UmbracoCms.IdentityExtensions.AzureActiveDirectory
             * 
